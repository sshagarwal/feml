...
function onAccept()
{
  ...
  try {
    ...
    Components.utils
              .reportError("Server Username: " + accountData.server.username);
    ...
    Components.utils.reportError("type: " + account.incomingServer.type);
    ...
    Cu.reportError("accName: " + account.toString());
  } catch(e) {
    dump("dump Error: " + e);
  }
